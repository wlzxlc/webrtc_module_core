...
enum {
    ...
    QCOM_HAL_PIXEL_FORMAT_NV12_ENCODEABLE = 0x102, //NV12
...
public:
    ...
    void getSupportedPreviewFpsRange(vector<Range> &ranges) const;
    ...
    void dump() const;
    int dump(int fd, const vector<string>& args) const;
    ...
    static const char KEY_DAY_NIGHT_MODE[];
    static const char KEY_SUPPORTED_DAY_NIGHT_MODE[];
