...
# Date:    2016-05-29 20:17:46
#===========================================================================#

ANDROID_MIN_TARGET_SDK := 14
ANDROID_NDK ?= /home/wlzx/tools/android-ndk-r10e
...
APP_ALIAS_BOARD := android-$(ANDROID_MIN_TARGET_SDK)
...
APP_TOOLCHAIN_SYSROOT := $(ANDROID_NDK)/platforms/android-$(ANDROID_MIN_TARGET_SDK)/arch-arm
